    ...
    <section className="w-full py-20 bg-black text-white overflow-hidden">
      ...
      <div className="max-w-7xl w-full mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Card 1 */}
          <div className="bg-gray-800 p-6 rounded-xl hover:-translate-y-2 transition duration-300">
          ...
          <div className="bg-gray-800 p-6 rounded-xl hover:-translate-y-2 transition duration-300">
            <p className="text-gray-200 mb-4">
              “Best car purchase ever. Safety features and smooth driving makes
              our every journey enjoyable.”
            </p>
